...
{
    public class CompraForEditValidator : AbstractValidator<CompraForEdit>
    {
        private readonly IEnergeticoDivisionService _serviceEnergeticoDivision;
        public CompraForEditValidator(IEnergeticoDivisionService serviceEnergeticoDivision)
        {
            ...
            private bool tieneNumeroCliente(long divisionId, long? energeticoId, bool sinMedidor)
            {
                ...
                var result = _serviceEnergeticoDivision.TieneNumCliente(divisionId, energeticoId);
