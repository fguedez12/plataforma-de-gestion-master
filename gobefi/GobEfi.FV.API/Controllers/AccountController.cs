...
namespace GobEfi.FV.API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(IConfiguration configuration, ISectorPublicoService sectorPublicoService,ILogger<AccountController> logger )
        {
        ...
        public async Task<ActionResult<UserTokenDTO>> Login([FromBody] UserDTO model)
        {
            ...
            {
                _logger.LogInformation($"Log usuario:${resultado.Nombre} id:{resultado.Id}");
